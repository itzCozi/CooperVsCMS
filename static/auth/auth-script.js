    ...
    .then(() => {
      ...
      onAuthStateChanged(auth, (user) => {
        if (user) {
          ...
          if (!(window.location.href.includes("/auth/login-page.html") || window.location.href.includes("/auth/register/register-page.html") || window.location.href.includes("/auth/anon/anon-login.html"))) {
